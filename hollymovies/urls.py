...
urlpatterns = [
    ...
    path('new_staff/', StaffCreateView.as_view(), name='new_staff'),             # Josef Krčmář
    path('staff/update/<pk>/', StaffUpdateView.as_view(), name='update_staff'),  # Josef Krčmář
    path('staff/delete/<pk>/', StaffDeleteView.as_view(), name='delete_staff'),  # Josef Krčmář
